...
citation: '<strong>Wenhan, Wu</strong> et al. "Mimir: Data-Free Federated Unlearning Through Client-Specific Prompt Generation for Personalized Models." IEEE Transactions on Mobile Computing (2025).'
---
